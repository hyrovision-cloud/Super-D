...
export const PatientProfileView: React.FC = () => {
  ...
  const canCreateRecord = hasPermission('medical_record.create');
  const canUpdatePatient = hasPermission('patient.update');
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 self-start lg:self-center">
            <select
              ...
              className="text-xs border border-surface-border rounded-lg px-3 py-1.5 bg-white font-medium text-text-main focus:ring-2 focus:ring-brand-blue/30 focus:outline-none disabled:opacity-60"
            >
