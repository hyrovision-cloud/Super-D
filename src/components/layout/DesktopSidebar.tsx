...
import { ROLE_SIDEBAR_SECTIONS, NavItemConfig } from '@/routes/rolePermissions';
...
export const DesktopSidebar: React.FC = () => {
  ...
  const sections = ROLE_SIDEBAR_SECTIONS[currentRole] || ROLE_SIDEBAR_SECTIONS['Super Admin'] || [];
