...
// Branch Comparison Chart Data (11.09.2026)
...
// Revenue Composition Donut Data (Trichy Branch 08.09.2026)
const DONUT_DATA = [
...
export const IncomeReportsView: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    const rows = [
      ...
      ['Consolidated Total', '763488', '376', '172'],
    ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            View revenue, collection and patient statistics across all branches
          </p>
        </div>
      ...
      {/* Row 1: 5 KPI Cards (Pixel accurate from screenshot) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xl font-extrabold text-slate-900 mt-0.5">₹ 7,63,488</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
              <TrendingUp className="w-3 h-3" /> ↑ 12% <span className="text-slate-400 font-normal">vs previous period</span>
            </span>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xl font-extrabold text-slate-900 mt-0.5">376</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xl font-extrabold text-slate-900 mt-0.5">172</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
              <TrendingUp className="w-3 h-3" /> ↑ 6% <span className="text-slate-400 font-normal">vs previous period</span>
            </span>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xl font-extrabold text-slate-900 mt-0.5">₹ 14,600</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {/* Card 1: Branch Comparison Bar Chart */}
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-[#0d6efd]" />
              <h3 className="font-bold text-sm text-slate-900">Branch Comparison</h3>
            </div>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={BRANCH_BAR_DATA} margin={{ top: 20, right: 20, left: 0, bottom: 5 }}>
                ...
                />
                <Bar dataKey="revenue" fill="#0d6efd" radius={[4, 4, 0, 0]} barSize={32} />
                <Bar dataKey="patients" fill="#10b981" radius={[4, 4, 0, 0]} barSize={20} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>

        {/* Card 2: Revenue Datewise Multi-line Chart */}
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        {/* Table 1: Branch Comparison Report (11.09.2026) - 5 Cols */}
        <div className="lg:col-span-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
                  ...
                  if (row.type === 'header') {
                    return (
                      <tr key={idx} className="bg-slate-50 font-bold text-slate-800">
                        <td colSpan={4} className="py-1.5 px-3 text-[11px] text-center text-[#0d6efd]">
                          {row.particular}
                        </td>
                      </tr>
                    );
        ...
        {/* Card 2: Revenue Composition Donut Chart - 4 Cols */}
          ...
          <div>
            ...
            <div className="relative h-48 w-full my-2">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-sm font-extrabold text-slate-900">₹ 47,033</span>
        ...
        {/* Card 3: Branch-wise Patient Summary - 4 Cols */}
        <div className="lg:col-span-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-3">
          ...
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/60 text-[11px] text-slate-500 mt-4">
            Total patients registered across all 3 monitoring branches: <strong className="text-slate-800">376</strong>
          </div>
        </div>
      </div>

      {/* Row 4: Trichy Branch Daily Report (08.09.2026) Split Card */}
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200 mb-4">
          <div className="flex items-center gap-2">
            <Building2 className="w-4 h-4 text-[#0d6efd]" />
            <h3 className="font-bold text-sm text-slate-900">
              {dailyReportBranch} Branch Daily Report ({dailyReportDate})
            </h3>
          </div>
          ...
          <div className="flex items-center gap-3 text-xs">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-700 font-semibold">
              ...
              <span>{dailyReportDate}</span>
            </div>
          </div>
        </div>

        {/* 3-Column Split Table from WhatsApp image */}
          ...
          <div className="border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="divide-y divide-slate-100">
              <div className="flex justify-between px-3 py-2">
                ...
                <span className="font-bold text-slate-900">
                  {TRICHY_DAILY_REPORT.patients.totalPatients}
                </span>
              </div>
              <div className="flex justify-between px-3 py-2">
                <span className="text-slate-600">In that New Patients</span>
                <span className="font-bold text-slate-900">
                  {TRICHY_DAILY_REPORT.patients.newPatients}
                </span>
              </div>
              <div className="px-3 py-2">
                <div className="flex justify-between font-semibold text-slate-700 mb-1">
                  ...
                  <span className="font-bold text-slate-900">
                    {TRICHY_DAILY_REPORT.patients.dressing}
                  </span>
                </div>
              ...
              <div className="flex justify-between px-3 py-2">
                ...
                <span className="font-bold text-slate-900">
                  {TRICHY_DAILY_REPORT.patients.burningSensation}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="divide-y divide-slate-100">
              <div className="flex justify-between px-3 py-2">
                ...
                <span className="font-semibold text-slate-900">
                  {TRICHY_DAILY_REPORT.collection.op.toLocaleString('en-IN')}
                </span>
              </div>
              <div className="flex justify-between px-3 py-2">
                <span className="text-slate-600">Medical</span>
                <span className="font-semibold text-slate-900">
                  {TRICHY_DAILY_REPORT.collection.medical.toLocaleString('en-IN')}
                </span>
              </div>
              <div className="flex justify-between px-3 py-2">
                <span className="text-slate-600">Lab</span>
                <span className="font-semibold text-slate-900">
                  {TRICHY_DAILY_REPORT.collection.lab.toLocaleString('en-IN')}
                </span>
              </div>
              <div className="flex justify-between px-3 py-2 bg-blue-50/80 font-extrabold text-[#0d6efd]">
                <span>Total Collection</span>
                <span>₹ {TRICHY_DAILY_REPORT.collection.total.toLocaleString('en-IN')}</span>
              </div>
            </div>
          </div>
            ...
            <div className="divide-y divide-slate-100">
              <div className="flex justify-between px-3 py-2">
                ...
                <span className="font-bold text-emerald-600">
                  ₹ {TRICHY_DAILY_REPORT.otherAmounts.dressingAmount.toLocaleString('en-IN')}
                </span>
              </div>
              <div className="flex justify-between px-3 py-2">
                <span className="text-slate-600">Day Care</span>
                <span className="font-bold text-purple-600">
                  ₹ {TRICHY_DAILY_REPORT.otherAmounts.dayCare.toLocaleString('en-IN')}
                </span>
              </div>
              <div className="p-3 bg-slate-50 text-[11px] text-slate-500">
                Data reconciled against daily clinical log receipts for Trichy branch.
              </div>
            </div>
          </div>
        </div>
