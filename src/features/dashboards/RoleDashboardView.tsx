...
export const RoleDashboardView: React.FC = () => {
  ...
  if (currentRole === 'Super Admin' || currentRole === 'Hospital Owner') {
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs">
            ...
            <p className="text-2xl font-extrabold text-slate-900 mt-2">₹ 7,63,488</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1 mt-1">
              <TrendingUp className="w-3 h-3" /> ↑ 12% vs previous period
            </span>
          </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs">
            ...
            <p className="text-2xl font-extrabold text-slate-900 mt-2">376</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1 mt-1">
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs">
            ...
            <p className="text-2xl font-extrabold text-slate-900 mt-2">172</p>
            <span className="text-[11px] text-emerald-600 font-semibold flex items-center gap-1 mt-1">
              <TrendingUp className="w-3 h-3" /> ↑ 6% vs previous period
            </span>
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-[#0d6efd]">
                <span>View Analytics (₹ 7,63,488)</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </div>
            </Link>
