...
const PERMISSION_GROUPS: PermissionDefinition[] = [
  {
    ...
    permissions: [
      ...
      { key: 'discharge.view', label: 'View Discharge Summaries' },
      { key: 'discharge.create', label: 'Issue Discharge Summary' },
    ],
  },
  {
    ...
    permissions: [
      ...
      { key: 'appointment.transition', label: 'Check-in & Status Workflow' },
      { key: 'appointment.reschedule', label: 'Reschedule Appointments' },
    ],
  },
  {
    ...
    permissions: [
      ...
      { key: 'leave.review', label: 'Review & Recommend Leave' },
      { key: 'leave.final_approve', label: 'Final Approve / Reject Leave' },
    ],
  },
  {
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'revenue.export', label: 'Export Financial Ledgers' },
      { key: 'marketing.view', label: 'View Campaign Analytics' },
      { key: 'marketing.manage', label: 'Create & Manage Ads' },
      { key: 'report.view', label: 'Access Scoped Reports' },
      { key: 'report.export', label: 'Export PDF / CSV Reports' },
    ],
  },
  {
